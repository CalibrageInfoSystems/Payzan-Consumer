 ...
 */
package com.calibrage.payzanconsumer.framework.util.barcodeCamera;
...
public class CameraSource {
    ...
    private int[] selectPreviewFpsRange(Camera camera, float desiredPreviewFps) {
        ...
        // that the desired value is outside of, but this is often preferred.  For complete_payment, if the
